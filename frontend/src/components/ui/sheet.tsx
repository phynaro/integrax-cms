  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        className={cn(
          "fixed z-50 flex flex-col gap-4 overflow-y-auto bg-popover bg-clip-padding p-4 text-xs/relaxed text-popover-foreground shadow-lg outline-none transition ease-in-out data-open:animate-in data-closed:animate-out data-open:duration-300 data-closed:duration-200 data-closed:fade-out-0 data-open:fade-in-0",
          side === "right" &&
